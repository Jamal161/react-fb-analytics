...
exports.AID_PowerPixelInit = void 0;
...
function AID_PowerPixelInit(pixelEvents) {
    // Bot-Checker Regex.
...
exports.AID_PowerPixelInit = AID_PowerPixelInit;
...
function triggerEvents(pixelEvents, eventName) {
    var eventId = functions_1.makeid(16);
    pixel_1.facebookPixelEvent(eventName, eventId);
